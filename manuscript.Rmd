...
## Ancestral biome reconstruction and biogeographic history
...
- Limitations is we can only coarsely assign species to one biome one some are range-limited endemics on islands (e.g. _A. longissimus_)
...
## Environment-dependent diversification
- Diversification rate decrease with aridification. 
