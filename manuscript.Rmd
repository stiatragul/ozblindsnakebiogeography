...
Consistent with @marinTracing2013, we found the initial diversification occurred very rapidly (<1 million years) in the tropical grassland biome followed by multiple transitions into the arid biome and subsequent expansion to the Mediterranean biome. However, our results show that the timing of these transition and diversification in the arid biome, for both species in groups 1 and 2, occured earlier (20 – 10 MYA) than previously proposed (10 MYA) by @marinTracing2013. 
...
Alternatively, this suggests that these lineages have diversified before the intensive continent-wide aridification in the late Miocene that resulted in the present dry and sandy red centre of Australia [@byrneBirth2008]. 
This pattern may indicate that blind snakes, like other fossorial animals, are pre-adapted to arid environments (CITE). Subterranean microhabitat is relatively stable compared to ground. 
