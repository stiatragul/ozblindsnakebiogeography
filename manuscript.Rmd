...
However, as opposedrecent invasion (<10 MYA) and diversification (<5 MYA) into the arid zone [@marinHidden2013], our results show that species in both groups 1 and 2 have deep divergence between 20 – 10 MYA, during the time when the Australia was still relatively wet and humid [@byrneBirth2008]. This suggests that these lineages have diversified before the intensive continent-wide aridification in the late Miocene that resulted in the present dry and sandy areas of the arid biome [@byrneBirth2008]. 
...
Our results suggest that range expansion was important for diversification. The fact that DEC+J+x model was preferred over DEC+J may be due to poor dispersal ability as closely related species occupy the same or nearby areas. Events like floods are likely to have faciliated dispersals but in short distances. 
