...
We applied GeoHiSSE models to evaluate whether speciation, extinction, and turnover rates differ between lineages in arid, non-arid, and widespread ranges. We found that the model where where geographic range was not linked to variation in diversification rates but rather to a hidden unobserved state fit the data better than models where diversification rates were depdendent on geographic range (see supp-table-geohisse). The best-fitting model accounts for 0.95 of the AIC weight and had AIC value 7.02 units lower than that of the second best-fitting model (see suupp-table-geohiss). The weighted average parameter estimates indicate both diversification rates and turnover rates did not differ between arid and non-arid ranges (REF FIGURE).

Results from our ClaDS analysis is consistent with that of GeoHiSSE, showing branch-specific diversification rates slow down towards the present. 

The analysis shows slow down in diversification rates over time. 
