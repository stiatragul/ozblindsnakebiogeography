...
One hypothesis to explain contemporary distribution in the arid biome is that *Anilios* may be pre-adapted to arid environments. Blind snakes have been found in xeric areas around the world, for example _Myriopholis macrorhyncha_ in the desert 

North American  and the Palearctic _Letheobia episcopus_) possibly because subterranean microhabitat has relatively stable climate compared to surface [@kinlawReview1999;@nevoAdaptive1979].



We found that closely related species share similar biome and distribution. 
