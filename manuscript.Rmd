...
<!-- Anilios_bituberculatus - distributed in the arid zone but also many occurrence in coastal areas in southern Australia. Classified as non-arid.
...
## Local vs global paleoenvironment 
...
Additionally, long naked branches in our current phylogeny, particularly in Group 1, suggests past extinction events. However, the lack of *Anilios* fossils makes extinction events difficult to identify [@loucaWhy2021;@raboskyExtinction2010]. An alternative explanation for decrease diversification is limited sampling of Australian blind snake, particularly in major sand deserts [@pepperLife2021] or even in areas of high cryptic diversity such as the Kimberley [@ellisTyphlopid2019]. The current phylogeny is missing 12 described species [@tiatragulAustralia2022], such as the arid-adapted _A. fossor_ and _A. minimus_, and the true diversity has been estimated to exceed 56 species [@marinHidden2013;@marinTracing2013;@ellisTyphlopid2019]. It is possible that these lineages that are not represented in our phylogeny have diversified more recently when aridity is high.

## Diversification rates in arid vs non-arid biomes
