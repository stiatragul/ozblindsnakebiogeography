...
Our result supports the hypothesis that the ancestor of the Australian clade first invaded the mesic part of the Australian continent between 25.8 – 16 MYA [@marinTracing2013]. Our analyses cannot conclude whether the Australian radiation was a result of an oceanic dispersal from Southeast Asia or Indonesia as previously proposed [@vidalBlindsnake2010]. Instead, our results suggest the ancestor of Australian _Anilios_ occured either in the Bismarck Archipelago, New Guinea, or a combination of both. 
...
After arriving to Australia in the late Oligocene - early Miocene (~25 MYA), the ancestral _Anilios_ initially diversified rapidly within less than 1 million years. Our analysis is consistent with the conclusion that Australian blindsnakes, like several other Australian squamates, originated from tropical-mesic origins and expanded into the arid biome since the mid-Miocene [@chappleParallel2004;@melvilleEvolutionary2011]. For example elapid snakes were hypothesised to have colonised Australia from Southeast Asia (CITE) or New Guinea (cite) around the same time (cite Paul). 

However, we were not able to include the New Guinean endemic _Anilios erycinus_, which is the only recognised species of _Anilios_ not found in Australia. Therefore, we cannot make any conclusions about transitions between New Guinea and Australia even though at least two species (i.e. _A. torresianus_ and _A. leucoproctus_) are found between southern New Guinea and Far North Queensland 

Placement of _R. multilineatus_ in the phylogeny renders _Ramphotyphlops_ paraphyletic (as discussed in Tiatragul 2023) 
The sister group to _Anilios_ is the genus _Ramphotyphlops_, which comprises XX species of blind snakes that occur in mesic areas across south and southeast Asia. 
...
- Topography dynamics [@brazModelling2021]
...
- However, the rates of diversification slowed down as Australia started to become more arid. We found that transitions into the arid biome for many lineages actually pre-dated the intense aridification in the late Miocene, which indicates that blind snakes may be pre-adapted to arid environment. This pattern has been observed in XXX (Paul Oliver's paper about __ reptile). Arid environemnts is heterogenous and some areas have acted as refugia during glaciation, which may cause isolation and subsequent speciation. 
