...
With 47 recognised species, the mostly Australian-endemic genus *Anilios* is currently the most diverse genus of scolecophidia in the world. In this study we inferred the the genus has a tropical grassland origin. Within a few million years the ancestral lineage diversified rapidly and the tropical grassland biome served as a major source of diversification as lineages transitioned into what we now consider the arid biome and subsequently into the mediterranean and temperate XXXXgrassland biomes. 
We found that paleo aridity index provides the best fit to diversification dynamics observed in our blind snake tree. 
Although aridification has been shown to accelerate diversification in other groups of vertebrates, we found that *Anilios* blind snakes follow a different trajectory. Increased aridity from the late Miocene-early Pleistocene coincided with reduced diversification rates for genus. 

SCIENTIFIC FINDING AS EXTENSION OF PREVIOUS WORK 

FINDINGS' SCIENTIFIC IMPLICATIONS 

HOW THIS WILL FACILITATE FUTURE RESEARCH 


FORWARD-LOOKING STATEMENTS ABOUT FIELD AS A WHOLE 
- As more genetic data allow us to build more extensive phylogenies, there is a growing need to develop methods and ways that can estimate environmental conditions in the past. Having this will allow us to test further hypotheses about how different macroevolutionary processes influence diversification on a larger scale. 

IMPORTANCE OF THIS TECHNICAL ASPECT OF THIS WORK 
- We show that reconstruction of localised paleo environment is possible and argue that it is more appropriate as a correlate to diversification rates. 
- Building these paleoclimate models for regional areas will be of interested for studies where species are geographically restricted. 
...
- However, the rates of diversification slowed down as Australia started to become more arid. We found that transitions into the arid biome for many lineages actually pre-dated the intense aridification in the late Miocene, which indicates that blind snakes may be pre-adapted to arid environment. This pattern has been observed in XXX (Paul Oliver's paper about ____ reptile). Arid environemnts is heterogenous and some areas have acted as refugia during glaciation, which may cause isolation and subsequent speciation. 
...
- Diversification rate decrease with aridification. But this is not explained by lineages transitioning into the arid biome as diversification rates did not differ between lineages in arid and non-arid biomes. 

- Our RPANDA model did not model environment-dependent extinction. 
- Extinction is a big cavaet especially because we suspect there are more species
