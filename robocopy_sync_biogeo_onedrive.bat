...
robocopy "C:\Users\ST\Documents\repo\blindsnakebiogeography\\" "C:\Users\ST\OneDrive - Australian National University\repo_onedrive\blindsnakebiogeography_onedrive\\" *.ai *.psd *.pdf *.png *.jpg *.png *.xlsx *.xls *.docx *.qgz *wwf_terr* *map* terr_biome* *.RData *.dbf *.prj *.shp *.shx *.qpj *.ait *.zip *.jld2 /S /XO /R:1 /W:1 /NDL /XJD /v /LOG+:"C:\Users\ST\Documents\repo\blindsnakebiogeography:src.log"
