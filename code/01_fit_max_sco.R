...
env_data <- env_data_list$max_sco
#################
## Fit the models ##
#################
...
# write.table(final_Anilios,file="data/intermediate_data/diversification_analyses/Results_Anilios_max_sco.txt", quote=FALSE,sep="\t",row.names=FALSE)
# save(final_Anilios,file="data/intermediate_data/diversification_analyses/Results_Anilios_max_sco.Rdata")
# save(Anilios_res,file="data/intermediate_data/diversification_analyses/Anilios_EnvDep_max_sco.Rdata")
write.table(final_Anilios,file="data/intermediate_data/diversification_analyses/Results_Anilios_max_sco_b.txt", quote=FALSE,sep="\t",row.names=FALSE)
save(final_Anilios,file="data/intermediate_data/diversification_analyses/Results_Anilios_max_sco_b.Rdata")
save(Anilios_res,file="data/intermediate_data/diversification_analyses/Anilios_EnvDep_max_sco_b.Rdata")
