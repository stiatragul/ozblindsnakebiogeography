# 03_anilios_BioGeoBEARS_parallel.R
# August 2022
...
runslow = TRUE
resfn = "data/intermediate_data/bears/AniliosDEC.Rdata"
if (runslow)
{
...
resfnj = "data/intermediate_data/bears/AniliosDEC_J.Rdata"
runslow = TRUE
if (runslow)
{
...
# load the saved result.
runslow = TRUE
resfnx = "data/intermediate_data/bears/AniliosDEC_X.Rdata"
if (runslow)
{
...
# resfnjx = "data/intermediate_data/bears/AniliosDEC_JX.Rdata"
resfnjx = "data/intermediate_data/bears/AniliosDEC_JX_full.Rdata"
runslow = TRUE
if (runslow)
{
...
runslow = TRUE
resfndiva = "data/intermediate_data/bears/AniliosDIVA.Rdata"
if (runslow)
{
...
runslow = TRUE
resfndivaj = "AniliosDIVA_J.Rdata"
if (runslow)
{
...
runslow = TRUE
resfndivax = "AniliosDIVA_X.Rdata"
if (runslow)
{
...
runslow = TRUE
resfndivajx = "data/intermediate_data/bears/AniliosDIVA_JX.Rdata"
if (runslow)
{
...
runslow = TRUE
resfnbayes = "data/intermediate_data/bears/AniliosBAYES.Rdata"
if (runslow)
{
...
runslow = TRUE
resfnbayesj = "data/intermediate_data/bears/AniliosBAYES_J.Rdata"
if (runslow)
{
...
runslow = TRUE
resfnbayesx = "data/intermediate_data/bears/AniliosBAYES_X.Rdata"
if (runslow)
{
...
runslow = TRUE
resfnbayesjx = "data/intermediate_data/bears/AniliosBAYES_JX.Rdata"
if (runslow)
{
...
# save.image(file = "data/intermediate_data/bears/bears_model_fit.Rdata")
