...
env_data <- env_data_list$max_val
...
# write.table(final_Anilios,file="data/intermediate_data/diversification_analyses/Results_Anilios_max_val.txt", quote=FALSE,sep="\t",row.names=FALSE)
# save(final_Anilios,file="data/intermediate_data/diversification_analyses/Results_Anilios_max_val.Rdata")
# save(Anilios_res,file="data/intermediate_data/diversification_analyses/Anilios_EnvDep_max_val.Rdata")
write.table(final_Anilios,file="data/intermediate_data/diversification_analyses/Results_Anilios_max_val_b.txt", quote=FALSE,sep="\t",row.names=FALSE)
save(final_Anilios,file="data/intermediate_data/diversification_analyses/Results_Anilios_max_val_b.Rdata")
save(Anilios_res,file="data/intermediate_data/diversification_analyses/Anilios_EnvDep_max_val_b.Rdata")
