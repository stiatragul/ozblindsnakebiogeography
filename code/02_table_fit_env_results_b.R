...
# This script will organise the results from the parallel fit and the individual fit together in one table from fitting on B tree (with cauchy priors).
