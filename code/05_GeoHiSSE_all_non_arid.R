...
state <- read.csv("data/intermediate_data/geohisse/arid_nonarid_binary_all_non_arid.csv", header = T)
...
prop_df <- read.csv("data/intermediate_data/geohisse/2022_species_list_arid_nonarid_binary_all_non_arid.csv", header = T)
...
mod4 <- GeoHiSSE(phy = phy, data = state, f=fraction,
                 turnover=turnover, eps=eps,
                 hidden.states=TRUE, trans.rate=trans.rate.mod,
                 turnover.upper=100, trans.upper=20)
...
# save.image(file = 'data/intermediate_data/geohisse/geohisse_binary_nonarid.Rdata')
load('data/intermediate_data/geohisse/geohisse_binary_nonarid.Rdata')
