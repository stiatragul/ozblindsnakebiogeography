...
state <- read.csv("data/intermediate_data/geohisse/arid_nonarid_binary_all_arid.csv", header = T)
...
prop_df <- read.csv("data/intermediate_data/geohisse/2022_species_list_arid_nonarid_binary_all_arid.csv", header = T)
...
# save.image(file = 'data/intermediate_data/geohisse/geohisse_binary_arid.Rdata')
load('data/intermediate_data/geohisse/geohisse_binary_arid.Rdata')
