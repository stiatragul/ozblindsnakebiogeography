...
env_data <- env_data_list$arid_str
...
# write.table(final_Anilios,file="data/intermediate_data/diversification_analyses/Results_Anilios_arid_str.txt", quote=FALSE,sep="\t",row.names=FALSE)
# save(final_Anilios,file="data/intermediate_data/diversification_analyses/Results_Anilios_arid_str.Rdata")
# save(Anilios_res,file="data/intermediate_data/diversification_analyses/Anilios_EnvDep_arid_str.Rdata")
write.table(final_Anilios,file="data/intermediate_data/diversification_analyses/Results_Anilios_arid_str_b.txt", quote=FALSE,sep="\t",row.names=FALSE)
save(final_Anilios,file="data/intermediate_data/diversification_analyses/Results_Anilios_arid_str_b.Rdata")
save(Anilios_res,file="data/intermediate_data/diversification_analyses/Anilios_EnvDep_arid_str_b.Rdata")
